...
if args.command == "download":
    ...
    main.download(info["versions"][0]["url"], f"{args.output_dir}/{make_safe_filename(info['title']) if not args.output_file else args.output_file}{' v' + info['versions'][0]['version'] if not args.output_file else ''}", not args.output_file)
